...
namespace CSG.MI.TrMontrgSrv.Helpers
{
    ...
    public static class ImageHeaderHelper
    {
        ...
        private static readonly Dictionary<byte[], Func<BinaryReader, Size>> imageFormatDecoders = new()
        {
        ...
        /// <exception cref="ArgumentException">The image was of an unrecogdnised format.</exception>
        public static Size GetDimensions(string path)
        {
            try
            {
                ...
                catch (ArgumentException e)
                {
                    ...
                    throw new ArgumentException(newMessage, nameof(path), e);
                }
            }
