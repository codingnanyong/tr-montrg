...
{
    public interface IRoiRepository : IGenericMapRepository<RoiEntity, Roi>
    {
        ...
        ICollection<Roi> FindBy(string startYmd, string startHms, string endYmd, string endHms, string deviceId, int? roiId);

        ICollection<Roi> FindBy(DateTime startTime, DateTime endTime, string deviceId, int? roiId);

        Task<ICollection<Roi>> FindByAsync(string startYmd, string startHms, string endYmd, string endHms, string deviceId, int? roiId);

        Task<ICollection<Roi>> FindByAsync(DateTime startTime, DateTime endTime, string deviceId, int? roiId);
